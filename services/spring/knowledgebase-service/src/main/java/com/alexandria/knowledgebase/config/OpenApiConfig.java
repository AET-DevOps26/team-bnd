...
@OpenAPIDefinition(
        info = @Info(
                title = "Alexandria KnowledgeBase Service API", version = "6.0.0", description = "Document management, tagging, and text search. Owns the documents/tags/search-queries tables and calls the GenAI service for summarization and entity extraction.", license = @License(name = "MIT", identifier = "MIT")
