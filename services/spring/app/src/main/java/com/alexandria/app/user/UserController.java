...
public class UserController {
    ...
    @ApiResponse(responseCode = "404", description = "User not found")
    public ResponseEntity<UserPreferencesDto> updateUserPreferences(Principal principal, @Valid @RequestBody UpdatePreferencesRequest request) {
        String oidcSubject = principal.getName();
