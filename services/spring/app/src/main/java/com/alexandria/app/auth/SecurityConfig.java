...
public class SecurityConfig {
  ...
  public SecurityConfig(
      JwtAuthenticationConverter jwtAuthConverter, OidcUserFilter oidcUserFilter) {
    this.jwtAuthConverter = jwtAuthConverter;
    this.oidcUserFilter = oidcUserFilter;
  }

  /**
   * Configures security filter chain with OAuth2 resource server. Publicly accessible: Swagger/API,
   * actuator and hello All other endpoints require a valid JWT from OIDC provider.
   *
